...
_JOSRT_API_FUNC void vector_create(vector_t* vec, size_t capacity, size_t element_size, generic_allocator_t* allocator);
// create and initialise a vector with an initial capacity and allocation units aligned to alignment
_JOSRT_API_FUNC void vector_create_aligned(vector_t* vec, size_t capacity, size_t element_size, alloc_alignment_t alignment, generic_allocator_t* allocator);
...
_JOSRT_API_FUNC void vector_push_back_pair(vector_t* vec, const void* first, size_t first_size, const void* second, size_t second_size);
...
_JOSRT_API_FUNC void queue_create(queue_t* queue, size_t capacity, size_t element_size, generic_allocator_t* allocator);
_JOSRT_API_FUNC void queue_pop(queue_t* queue);
_JOSRT_API_FUNC void queue_push(queue_t* queue, void* element);
_JOSRT_API_FUNC void queue_push_ptr(queue_t* queue, void* ptr);

_JOSRT_INLINE_FUNC bool queue_is_empty(queue_t* queue)
{
	return vector_is_empty(queue->_elements);
}

_JOSRT_INLINE_FUNC bool queue_is_full(queue_t* queue)
{
	return vector_is_full(queue->_elements);
}

_JOSRT_API_FUNC void* queue_front(queue_t* queue);

_JOSRT_INLINE_FUNC void queue_clear(queue_t* queue)
{
	vector_clear(queue->_elements);
	queue->_head = queue->_tail = 0;
}

_JOSRT_INLINE_FUNC void queue_destroy(queue_t* queue)
{
...
_JOSRT_API_FUNC void* queue_front_ptr(queue_t* queue);
...
_JOSRT_API_FUNC void unordered_map_create(unordered_map_t* umap, unordered_map_create_args_t* args, generic_allocator_t* allocator);
_JOSRT_API_FUNC void unordered_map_destroy(unordered_map_t* umap);
_JOSRT_API_FUNC map_value_t unordered_map_find(unordered_map_t* umap, map_key_t key);
_JOSRT_API_FUNC bool unordered_map_insert(unordered_map_t* umap, map_key_t key, map_value_t item);
_JOSRT_API_FUNC bool unordered_map_remove(unordered_map_t* umap, map_key_t key);
_JOSRT_API_FUNC size_t unordered_map_memory_footprint(unordered_map_t* umap);
_JOSRT_INLINE_FUNC size_t unordered_map_size(unordered_map_t* umap) {
	return umap->_occupancy;
}
_JOSRT_INLINE_FUNC generic_allocator_t* unordered_map_allocator(unordered_map_t* umap) {
...
_JOSRT_INLINE_FUNC void paged_list_create(paged_list_t* paged_list, size_t element_size, size_t items_per_page, generic_allocator_t* allocator) {
...
_JOSRT_API_FUNC void paged_list_push_back(paged_list_t* paged_list, void* item);
...
_JOSRT_INLINE_FUNC paged_list_iterator_t paged_list_iterator_begin(paged_list_t* paged_list) {	
...
_JOSRT_API_FUNC void paged_list_iterator_next(paged_list_iterator_t* iter);

_JOSRT_API_FUNC void paged_list_destroy(paged_list_t* paged_list);

_JOSRT_INLINE_FUNC bool paged_list_is_empty(paged_list_t* paged_list) {
	return !paged_list || !paged_list->_page0 || !paged_list->_items;
}

_JOSRT_INLINE_FUNC size_t paged_list_size(paged_list_t* paged_list) {
...
_JOSRT_INLINE_FUNC void _vector_check_grow(vector_t* vec) {
...
_JOSRT_INLINE_FUNC map_key_t _unordered_map_typed_key(unordered_map_t* umap, map_key_t key) {
...
_JOSRT_INLINE_FUNC _map_slot_value_t _unordered_map_find(unordered_map_t* umap, map_key_t key) {	
