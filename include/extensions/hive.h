...
_JOSRT_API_FUNC  void hive_create(hive_t* hive, generic_allocator_t* allocator);
// set/create a key -> value
_JOSRT_API_FUNC  void hive_set(hive_t* hive, const char* key, ...);
// create or append values to a list
_JOSRT_API_FUNC void hive_lpush(hive_t* hive, const char* key, ...);
// get the values for a key 
_JOSRT_API_FUNC jo_status_t hive_get(hive_t* hive, const char* key, vector_t* out_values);
// get the values for a list
_JOSRT_API_FUNC jo_status_t hive_lget(hive_t* hive, const char* key, vector_t* out_values);
// deletes an item from the hive
_JOSRT_API_FUNC jo_status_t hive_delete(hive_t* hive, const char* key);
...
_JOSRT_API_FUNC void hive_visit_values(hive_t* hive, 
...
_JOSRT_INLINE_FUNC size_t _hive_param_pack_size(va_list* pack) {
...
_JOSRT_INLINE_FUNC void _hive_parse_parameter_pack(va_list* params, char* pack) {
...
_JOSRT_INLINE_FUNC _hive_entry_t* _hive_find(hive_t* hive, const char* key) {
